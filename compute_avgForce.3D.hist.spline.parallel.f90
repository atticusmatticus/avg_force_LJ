...
module cfgData
   ...
   real(kind=dp) :: RStepSize, xzStepSize, R_min, R_max, xz_range, cfgCosThStepSize, cfgPhiStepSize, cfgPsiStepSize, T, cut, offset
...
subroutine spline_hist_array
   ...
   call ideal_CL3(histDistBins,histDistStepSize,histCosThBins,cosTh_min,cosTh_max,histPhiBins,phi_min,phi_hmax,radius,offset,T, &
      & idealHist)
